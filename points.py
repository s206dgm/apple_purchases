"""
Weekly streak tracker. Green week (<$150 total) earns a star.
5 consecutive stars → moon. 5 moons → sun.
Non-green week resets stars but keeps earned moons/suns.
...
def _load() -> dict:
    ...
    return {"stars": 0, "moons": 0, "suns": 0, "last_week_start": None}
